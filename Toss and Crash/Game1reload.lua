...
function scene:enterScene(event)	
		...
		game:insert( player )
		physics.addBody( player, { density=10.0, friction=0.5, bounce=0.2, radius=25 } )
		...
		local easingx  	= require("easing");
		game:insert( player2 )
		physics.addBody( player2, { density=10.0, friction=0.5, bounce=0.2, radius=25 } )
		...
		local function reload (event)
			if (event.phase == "began") then
				...
				storyboard.removeScene("Game1reload")
